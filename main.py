...
# Удаляем предыдущее сообщение, если оно есть
    if chat_id in user_data and "last_message_id" in user_data[chat_id]:
        try:
            bot.delete_message(chat_id, user_data[chat_id]["last_message_id"])
    ...
    # Кадр переходящий от choice == 1
        ...
        if choice == 0:
            ...
            bot.send_message(message.chat.id, "Приветствую тебя! Давай проверим твои знания в медицине, напиши /game и мы начнем.")
        elif choice == 3:
